...
const FIXED_LENS_PRICE = 2324; // Fixed price for all lenses in XRT

export const mockLenses: Lens[] = [
  { id: '887d80da-f4ba-4a40-a0d6-4e4d0cfb31b1', name: 'Lens 01', displayName: 'Cosmic Vibes', coverImage: lens1Cover, groupId: 'b5551368-7881-4a23-a034-a0e757ec85a7', price: FIXED_LENS_PRICE },
